...
if sys.platform.startswith('linux'):
    ...
    inputName = raw_input("Please enter the name of the verilog file: ")
    verilogFilename = inputName + ".v"
    ...
    new_file.write("module " + moduleDeclaration + "_tb;\n")
    new_file.write("\ninitial")
    new_file.write("\nbegin")
    new_file.write("\nend")
    new_file.write("\nendmodule")
...
if sys.platform.startswith('win'):
    ...
    while (1):
        ...
        while (inputValue > i-1 or inputValue <= 0):
            ...
            print("Input Variable: " + str(inputVariables))
            print("Output Variable: " + str(outputVariables))
